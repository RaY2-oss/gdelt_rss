...
COLLECT_LOOKBACK_HOURS = 2 # сколько 15-мин дампов забирать за один hourly-прогон
...
DIGEST_COVERAGE_BOOST = 5   # ponytail: линейная эвристика — очков важности сюжета
                            # за каждую доп. статью в кластере за неделю; заменить
                            # на что-то менее наивное, если она начнёт перевешивать
                            # одиночные сильные материалы
