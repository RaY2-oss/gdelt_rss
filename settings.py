...
# Держится ОТДЕЛЬНО от DIGEST_GRAPH_DAYS: граф важности считает недельное окно
# (расширять его — менять ранжирование), а архив — это про то, за сколько дней
# читатель может пролистать ленту назад, и одно другому не указ.
ARCHIVE_DAYS = 14
