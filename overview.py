...
def guarded(summary, source):
    ...
    Ловит выдуманные суммы, даты и количества, отказ модели, её же рассуждения
    вслух и дословное списывание. Смысловое враньё не ловит и не притворяется,
    что ловит: за это отвечает модель на том конце и отбор на входе. Отказ —
